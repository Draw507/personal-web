            ...
            var t = this.attr("id"),
                ...
                o = {
                        ...
                        "vertical" === e.themelayout && (satnt = e.defaultVerticalMenu.desktop,
                            "expanded" !== satnt && "compact" !== satnt || (mt = e.MenuTrigger,
                                "click" === mt && $("#mobile-collapse,#mobile-collapse1").click(function(e) {
                                    //////console.log('HandleVerticalScrollbar');
                                    e.preventDefault();
                                    var t = $(this);
                                    rel = t.attr("rel"),
                                        el = $(".pcoded-navbar"),
                    ...
                    HandleNavbarPosition: function() {
                        ...
                        ////console.log('FixedNavbarPosition ', e.FixedNavbarPosition);
                        ////console.log('FixedHeaderPosition ', e.FixedHeaderPosition);
                        ////console.log('FixedRightHeaderPosition ', e.FixedRightHeaderPosition);
                        switch (e.themelayout) {
                            case "vertical":
                            case "horizontal":
                    ...
                    HandleActiveItemStyle: function() {
                        ...
                        //console.log('ActiveItemStyle ', e.ActiveItemStyle);
                    ...
                    Handlemenutype: function() {
                        ...
                        //console.log('freamtype ', e.freamtype);
                    ...
                    HandleThemeBackground: function() {
                        ...
                        function() {
                            ...
                            //console.log('LHeaderBackground ', e.LHeaderBackground);
                        ...
                        function() {
                            ...
                            //console.log('SubItemBackground ', e.SubItemBackground);
                    ...
                    HandleVerticalLeftHeader: function() {
                        //console.log('collapseVerticalLeftHeader ', e.collapseVerticalLeftHeader);
                    ...
                    HandleOffcanvasMenu: function() {
                        //console.log('themelayout ', e.themelayout)
                        if ("vertical" === e.themelayout) {
                    ...
                    HandleMenuOnClick: function() {
                        ...
                        "vertical" === e.themelayout ? $("#mobile-collapse,#mobile-collapse1,.sidebar_toggle a, .pcoded-overlay-box,.menu-toggle a").on("click", function() {
                            ...
                            //console.log('HandleMenuOnClick', a);
                            if ("desktop" == a) {
                                var o = e.onToggleVerticalMenu.desktop,
                                    i = e.defaultVerticalMenu.desktop,
                                    d = $("#" + t).attr("vertical-nav-type");
                                //console.log('onToggleVerticalMenu', o);
                                //console.log('defaultVerticalMenu', i);
                                //console.log('vertical-nav-type', d);
                                if (d == i)
                    ...
                    HandleMenulayout: function() {
                        //console.log('verticalMenulayout ', e.verticalMenulayout);
                        if ("vertical" === e.themelayout)
